let students = [
    { ID: 1, name: 'Ram', age: 21, grade: '9', degree: 'Btech', email: 'ram@example.com' },
    { ID: 2, name: 'Charan', age: 22, grade: '8', degree: 'MBA', email: 'charan123@example.com' },
    { ID: 3, name: 'Ravi Teja', age: 20, grade: '8', degree: 'Arts', email: 'rt124@example.com' }
];
let addStudent ;
let editStudent ;
let searchField ;
